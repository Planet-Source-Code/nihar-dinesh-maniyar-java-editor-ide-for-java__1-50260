...
' #############################################################################
' #                                                                           #
' #             This is an example of scrolling a gutter                      #
' #  All credit for the DrawLines function goes to the guys at VBAccelerator  #
' #             Visit them at http://www.vbaccelerator.com                    #
' #                                                                           #
' #  This example simply shows how to use the API to pull out the VScroll     #
' #   and other things like line numbers, characters, etc and using it to     #
' #            to scroll something else. I hope you enjoy                     #
' #                 The code and That it's useful to you                      #
' #                                                                           #
' #                                                                           #
